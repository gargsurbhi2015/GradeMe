...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=PT+Sans:400,700,400italic,700italic' rel='stylesheet'
          type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Lobster+Two:400,700,400italic,700italic' rel='stylesheet'
          type='text/css'>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">Team - goMobile</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a class="page-scroll" href="#login" id ="loginLink">Login</a>
                </li>
                <li>
...
<header>
    <div class="container">
        <div class="intro-text">
            ...
            <div class="intro-heading">Check Your Grades</div>
...
<!-- Services Section -->
<section id="services" class="secimg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading"><font color="white">Features</font></h2>
        ...
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <h4 class="service-heading"><font color="white">Compute Grades </font></h4>
            ...
            <div class="col-md-4">
                ...
                <h4 class="service-heading"><font color="white"> Responsive Design</font></h4>
            ...
            <div class="col-md-4">
                ...
                <h4 class="service-heading"><font color="white"> Web Security </font></h4>
        ...
        <div class="row">
            <main id="content" class="widget-login-container" role="main">
                <div class="col-lg-4 col-sm-6 col-xs-10 col-lg-offset-4 col-sm-offset-3 col-xs-offset-1">
                    <div class="row" style="outline: auto"> 
                        <header>
                            <center><h2>LOGIN</h2></center>
                            <!--<center><h4>../h4></center>-->
                        </header>
                        <!--form class="mt-lg " method="post" action="http://www.karankh.com/db2.php"-->
						<form class="mt-lg " method="post" action="db.php">
                            <div class="form-group controls">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php if(isset($_COOKIE["error"])) { echo "<p>".$_COOKIE["error"]."</p>"; setcookie("error");} ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">goMobile-Our App</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <ul class="timeline">
                    <li>
                        <div class="timeline-image">
                            <img class="img-circle img-responsive" src="img/about/grades.jpeg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Step 1</h4>
                                <h4 class="subheading">Enter Student Grades</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted"> Enter the grades of your students. Our App makes it easy for you
                                    by providing a smart phone app.</p>
                            </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        <div class="timeline-image">
                            <img class="img-circle img-responsive" src="img/about/config.jpeg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Step 2</h4>
                                <h4 class="subheading">Configure your course details</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted">Make your green-sheets using templates. Configure grade ranges and
                                    grade weight age on line.</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="timeline-image">
                            <img class="img-circle img-responsive" src="img/about/checkGrades.jpeg" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Step 3</h4>
                                <h4 class="subheading">Check out your grades</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted"> Check out what your grade is in the last week's assignment on
                                    your phone. Your score card is now in your pocket.</p>
                            </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        <div class="timeline-image">
                            <img class="img-circle img-responsive" src="img/about/features.png" alt="">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Features</h4>
                            ...
                            <div class="timeline-body">
                                <p class="text-muted">1. Easy score card viewing <br> 2. Easy course configuration <br>
                                    3. Easy mark recordings</p>
                            </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">CMPE 235 - Mobile Software System Design</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="img/team/SurbhiGarg.png" class="img-responsive img-circle" alt="Surbhi" width="140px" height="140px">
                    <h4>Surbhi Garg</h4>
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="img/team/SaumeelGajera.jpg" class="img-responsive img-circle" alt="Saumeel" width="140px" height="140px">
                    <h4>Saumeel Gajera</h4>
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="img/team/2.jpg" class="img-responsive img-circle" alt="Karan" width="140px" height="140px">
                    <h4>Karan Khanna</h4>
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img src="img/team/1.jpg" class="img-responsive img-circle" alt="Darsh" width="140px" height="140px">
                    <h4>Darshpreet Kaur Narula</h4>
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img src=""img/team/1.jpg"" class="img-responsive img-circle" alt="Vineesha" width="140px" height="140px">
                    <h4>Vineesha</h4>

                    <p class="text-muted">Front End Engineerr</p>
                    <ul class="list-inline social-buttons">
                        <li><a href="#"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li><a href="#"><i class="fa fa-facebook"></i></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <a href="#">
                    <img src="img/logos/sjsu.png" class="img-responsive img-centered" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="#">
                    <img src="img/logos/grad.jpeg" class="img-responsive img-centered" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="#">
                    <img src="img/logos/sanjose%20.png" class="img-responsive img-centered" alt="">
                </a>
            </div>
            <div class="col-md-3 col-sm-6">
                <a href="#">
                    <img src="img/logos/target.jpeg" class="img-responsive img-centered" alt="">
                </a>
            </div>
        </div>
    </div>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <span class="copyright">Copyright &copy; CMPE 235 - goMobile 2016</span>
            </div>
            <div class="col-md-4">
                <ul class="list-inline social-buttons">
                    <li><a href="#"><i class="fa fa-twitter"></i></a>
